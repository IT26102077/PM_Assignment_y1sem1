...
typedef struct {
    ...
    int    hasFired;        /* Part 1-A/B/C, 2-A: can only fire once    */
    double impactFactorLeft;/* remaining "health" fraction (Part 2-C)   */
} EscortShip;
...
/* Summary of one battle iteration (Part 1-B/C: one point along B's path) */
typedef struct {
